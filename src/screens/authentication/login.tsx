        ...
        <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
                <View style={{marginTop:50}}>
                    <Text style={{ marginLeft: 10 }}><User color={theme.COLORS.text} size={20} style={{ marginRight: 10, alignSelf: 'center' }} />
                        <Label labeText='username: ' labelStyle={{ color: theme.COLORS.text}} /></Text>
                    <FormInput
                ...
                <View>
                    <View>
                        <Text style={{ marginLeft: 10 }}><Lock color={theme.COLORS.text} size={20} style={{ marginRight: 10, alignSelf: 'center' }} />
                        <Label labeText='password: ' labelStyle={{color:theme.COLORS.text}} /></Text>
                        <FormInput
...
const styles = StyleSheet.create({
    ...
    formContainer:{ display: 'flex', flexDirection: 'column', gap: 15, borderRadius:10, height:theme.screenHeight-500 },
    buttonText: {
        color: '#fff',
        fontSize: 18,
        textAlign: 'center',
