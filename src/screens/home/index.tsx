import { Dimensions, FlatList, Image, StyleSheet, RefreshControl, TouchableOpacity, View, Text } from 'react-native';
...
import { useGetCurrentUserInvoicesQuery, useInvoiceMutation } from '../../redux/apis/invoiceApi';
...
const styles = StyleSheet.create({
  ...
  card: {
    backgroundColor: "#d7e3fcff", height: 60, width: 60, alignItems: 'center', borderRadius: 10, marginVertical: 15, marginHorizontal: 15, paddingTop: 25, justifyContent: 'center'
  },
  invoice: { height: 50, width: 50, borderRadius: 10 },
  invoiceType: { color: '#0b0b0bff', textAlign: 'center', fontSize: 10, marginTop: 10, width: 70 },
